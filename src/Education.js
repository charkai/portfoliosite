...
const Education = () => {
    ...
    return (
        <animated.div style={fadeInUpStyle} className="w-full flex flex-col items-center px-10 md:px-40 pt-10">
            ...
            <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-gray-100 md:text-5xl lg:text-6xl">Education</h1>
            ...
            <h1 className="mb-8 mt-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-gray-100 md:text-5xl lg:text-6xl">Awards</h1>
            <ul className="px-10 mb-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow divide-y divide-gray-200 dark:divide-gray-700 max-w-full">
