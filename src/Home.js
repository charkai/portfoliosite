...
const Home = () => {
    ...
    return (
        <animated.div style={fadeInUpStyle} className="flex flex-col md:flex-row items-center justify-between pt-10 md:pt-0 md:px-6 md:max-h-[646px] md:overflow-y-hidden">
                ...
                <div className="w-full h-auto flex justify-between py-8 gap-2">
                    <div className="w-full h-auto py-8 flex items-center justify-center gap-2 flex-wrap">
                        <a href="https://www.linkedin.com/in/charlie-kairaitis-561a0920a/" target="_blank"
                            className="p-2 rounded-lg flex items-center border border-gray-300 dark:border-gray-700 justify-center transition-all duration-500 hover:border-purple-200 hover:bg-purple-100 dark:hover:border-purple-300 dark:hover:bg-purple-800">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none" className="text-gray-700 dark:text-white">
                                <path
